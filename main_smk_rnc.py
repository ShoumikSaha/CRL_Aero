...
def parse_option():
    ...
    parser.add_argument('--save_curr_freq', type=int, default=10, help='save curr last frequency')
...
def set_loader(opt):
    ...
    # get data transforms (my_transforms called from utils.py)
    #train_transform = get_my_transforms()
